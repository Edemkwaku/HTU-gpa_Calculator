Public Class Level200_1
    ...
    Private Sub submit_Click(sender As Object, e As EventArgs) Handles submit.Click
        ...
        ClassObtained()
        gpa3 = gpa.Text
        crH3 = total_CreditHour.Text
        cgpa3 = Gross_gpa.Text
    End Sub
    Private Sub Grade()
        'Grade points'
    ...
    Private Sub Level200_1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        bkGroung()
    End Sub
