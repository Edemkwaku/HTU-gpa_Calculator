Public Class Level200_2
    ...
    Private Sub submit_Click(sender As Object, e As EventArgs) Handles submit.Click
        ...
        ClassObtained()
        gpa4 = gpa.Text
        crH4 = total_CreditHour.Text

        cgpa4 = Gross_gpa.Text
    End Sub
    ...
    Private Sub ContinueBtn()
        ...
        End If
    End Sub
    Private Sub Level200_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        bckGroung()
    End Sub
