Public Class Level100_2
    ...
    Private Sub Level100_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        bacGround()
    ...
    Private Sub submit_Click_1(sender As Object, e As EventArgs) Handles submit.Click
        ...
        ' Dim allover As New Over
        'allover.ComboBox1.Items.Add(gpa.Text)
       

        'l100_2.Show()
        gpa2 = gpa.Text
        crH2 = total_CreditHour.Text
        cgpa2 = Gross_gpa.Text

        'allover.Show()
    End Sub

    Private Sub Guna2Button3_Click(sender As Object, e As EventArgs) Handles Guna2Button3.Click
        Dim L100_1 As New Level100_1
