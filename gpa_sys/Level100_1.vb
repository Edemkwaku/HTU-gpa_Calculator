Public Class Level100_1
    ...
    Private Sub submit_Click(sender As Object, e As EventArgs) Handles submit.Click
        ...
        GGpa = all.ToString("N2")
        gpa.Text = GGpa
        Double.TryParse(gpa.Text, all)

        'Class Obtabined'
        ClassObtained()

        'Transfer to Over Form
        gpa1 = gpa.Text
        crH1 = total_CreditHour.Text
        cgpa1 = Gross_gpa.Text
