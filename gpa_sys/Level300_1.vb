Public Class Level300_1
    ...
    Private Sub Level300_1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        bcGround()
    End Sub
    ...
    Private Sub Guna2Button4_Click(sender As Object, e As EventArgs) Handles cancel.Click
        Me.Close()
    End Sub

    Private Sub Guna2Button5_Click(sender As Object, e As EventArgs) Handles minimize.Click
        Me.WindowState = FormWindowState.Minimized
    End Sub
End Class